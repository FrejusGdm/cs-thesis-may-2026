...
class TTSDataset(Dataset):
    ...
    def collate_fn(self, batch):
        ...
        batch_size, total_length = len(batch), max_length

        input_ids = torch.zeros((batch_size, total_length, 2), dtype=torch.long)
        codec_ids = torch.zeros((batch_size, total_length, 16), dtype=torch.long)
        text_embedding_mask = torch.zeros((batch_size, total_length), dtype=torch.bool)
        codec_embedding_mask = torch.zeros((batch_size, total_length), dtype=torch.bool)
        codec_mask = torch.zeros((batch_size, total_length), dtype=torch.bool)
        attention_mask = torch.zeros((batch_size, total_length), dtype=torch.long)
        codec_0_labels = torch.full((batch_size, total_length), -100, dtype=torch.long)

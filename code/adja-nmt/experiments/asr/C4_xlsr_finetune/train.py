...
"""
C4: Fine-tune XLS-R (facebook/wav2vec2-xls-r-300m) on Adja ASR data with CTC.
...
def train(config: dict, data_dir: str, output_dir: str, seed: int, dry_run: bool):
    ...
    with open(samples_path, "w", encoding="utf-8") as f:
        f.write(f"C4 XLS-R Fine-Tune -- Decode Samples (best checkpoint)\n")
        f.write(f"{'='*70}\n\n")
...
# ===========================================================================
def main():
    parser = argparse.ArgumentParser(description="C4: Fine-tune XLS-R on Adja ASR")
    ...
    print(f"C4: XLS-R Fine-Tune on Adja ASR")
